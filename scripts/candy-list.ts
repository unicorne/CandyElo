...
export const CANDY_LIST: SeedCandy[] = [
  ...
  { name: "funny-frisch Kessel Chips", brand: "funny-frisch", query: "funny frisch Kessel Chips", barcode: "4003586108937", nameMust: ["kessel"], wikiTitle: "Funny-frisch" },
  { name: "Original Sahne Muh-Muhs", brand: "Storck", query: "Sahne Muh-Muhs Storck", nameMust: ["muh"], wikiTitle: "August_Storck" },
  { name: "Ültje Erdnüsse gesalzen", brand: "Ültje", query: "Ültje Erdnüsse", barcode: "4004980401907", nameMust: ["ültje", "ueltje"], wikiTitle: "Ültje" },
  { name: "Ferrero Giotto", brand: "Ferrero", query: "Ferrero Giotto", nameMust: ["giotto"], wikiTitle: "Giotto_(Süßware)" },
  { name: "Ferrero Rocher", brand: "Ferrero", query: "Ferrero Rocher", barcode: "8000500273296", nameMust: ["rocher"], wikiTitle: "Ferrero_Rocher" },
  { name: "Raffaello", brand: "Ferrero", query: "Raffaello", barcode: "4008400183022", nameMust: ["raffaello"], wikiTitle: "Raffaello_(Süßware)" },
  ...
  { name: "M&M's Peanut", brand: "Mars", query: "M&M Peanut Erdnuss", barcode: "5000159492737", nameMust: ["m&m", "peanut|erdnuss"], wikiTitle: "M&M's" },
  ...
  { name: "Bounty Riegel", brand: "Mars", query: "Bounty Riegel", barcode: "5000159557771", nameMust: ["bounty"], wikiTitle: "Bounty_(Schokoriegel)" },
  ...
  { name: "Hanuta", brand: "Ferrero", query: "Hanuta", barcode: "8000500272442", nameMust: ["hanuta"], wikiTitle: "Hanuta" },
  ...
  { name: "Kit Kat", brand: "Nestlé", query: "KitKat", nameMust: ["kit kat|kitkat|kit-kat"], wikiTitle: "KitKat" },
  ...
  { name: "Pom-Bär Original", brand: "Lorenz", query: "Pom-Bär Original", barcode: "4000522064302", nameMust: ["pom"], wikiTitle: "Pom-Bär" },
  ...
  { name: "Haribo Goldbären", brand: "Haribo", query: "Haribo Goldbären", nameMust: ["goldbär|goldbaer|gold-bear|gold bear|gummibär|gummibaer"], wikiTitle: "Goldbär" },
  ...
  { name: "Dickmann's Schokoküsse", brand: "Dickmann's", query: "Dickmann Schokoküsse", barcode: "4035800417006", nameMust: ["dickmann"], wikiTitle: "Schokokuss" },
  ...
  { name: "Haribo Schlümpfe", brand: "Haribo", query: "Haribo Schlümpfe", barcode: "4001686327722", nameMust: ["schlümpf|schluempf|smurf"], wikiTitle: "Haribo" },
  ...
  { name: "Milka Alpenmilch", brand: "Milka", query: "Milka Alpenmilch", barcode: "7622202257124", nameMust: ["milka", "alpenmilch", "alpine"], wikiTitle: "Milka_(Marke)" },
  ...
  // Added later by user request (not in original 90-list)
  { name: "Griesson Chocolate Mountain Cookies", brand: "Griesson", query: "Griesson Chocolate Mountain Cookies", barcode: "4001518116999", nameMust: ["chocolate mountain|griesson"] },
  { name: "Hitschler Saure Drachenzungen", brand: "Hitschler", query: "Hitschler Saure Drachenzungen", barcode: "4003840008843", nameMust: ["drachenzunge|nitschies"] },
];
